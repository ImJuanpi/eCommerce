...
public class UsersController {
	...
	public ResponseEntity<List<UserTO>> getUsers () {
		...
		returnResponse.forEach(eachuser ->
			eachuser.setAddress((List<AddressTO>) addressService.getAddressByCustomerId(eachuser.getUserId()))
		);
	...
	public ResponseEntity<UserTO> getUser (@PathVariable("id") int id ) {
		...
		responseValue.setAddress((List<AddressTO>) addressService.getAddressByCustomerId(responseValue.getUserId()));
